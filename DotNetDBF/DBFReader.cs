                ...
                for (int i = 0; i < _header.FieldArray.Length; i++)
                {
                    ...
                    switch (_header.FieldArray[i].DataType)
                    {
                        ...
                        case NativeDbType.Float:
                            ...
                            {
                                Logs.WriteLine("Failed to parse data: " + tparsed_debug + ", Field: " + _header.FieldArray[i].Name);
                        ...
                        case NativeDbType.Numeric:
                            ...
                            try
                            {
                                    ...
                                    && tLast != DBFFieldType.Unknown)
                                {
                                    ...
                                    {
                                        decimal temp = 0;
                                        Decimal.TryParse(tParsed, NumberStyles.Float | NumberStyles.AllowLeadingWhite, null, out temp);
                                        recordObjects[i] = temp;
                                    }
                                    catch
                                    {
                                        recordObjects[i] = null;
